...
Adafruit_HMC5883_Unified mag = Adafruit_HMC5883_Unified(12345); // Assign a Uniquej ID to the HMC5883 Compass Sensor
TinyGPSPlus gps; // The TinyGPS++ object
SoftwareSerial ss(RXPin, TXPin); // The serial connection to the NEO-6m GPS module
